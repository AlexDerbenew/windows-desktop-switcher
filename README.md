...
Switch virtual desktop by Win + <num>
Create new desktop by Win+~
Remove current desktop by Win+Esc
Move active window to desktop number <N> by Win+Shift+<N>
Move to Right/Left desktop by Win+<Right/Left>
